...
namespace KinguilaAppApi.UnitTests.Services.KinguilaHojeTextualInformationParserTests
{
    ...
    {
        [Theory]
        [InlineData("Actualizado em 20/Janeiro", 1, 20)]
        [InlineData("Actualizado em 20/Fevereiro", 2, 20)]
        [InlineData("Actualizado em 20/Março", 3, 20)]
        [InlineData("Actualizado em 20/Abril", 4, 20)]
        [InlineData("Actualizado em 20/Maio", 5, 20)]
        [InlineData("Actualizado em 20/Junho", 6, 20)]
        [InlineData("Actualizado em 20/Julho", 7, 20)]
        [InlineData("Actualizado em 20/Agosto", 8, 20)]
        [InlineData("Actualizado em 20/Setembro", 9, 20)]
        [InlineData("Actualizado em 20/Outubro", 10, 20)]
        [InlineData("Actualizado em 20/Novembro", 11, 20)]
        [InlineData("Actualizado em 20/Dezembro", 12, 20)]
